...
#$ -N test_all
#$ -S /bin/bash
#$ -wd /home/guotwang/tf_project/brats1517/brats17
#!/bin/bash
...
/share/apps/libc6_2.17/lib/x86_64-linux-gnu/ld-2.17.so --library-path $TF_LD_LIBRARY_PATH $(command -v /home/guotwang/miniconda3/bin/python3) /home/guotwang/tf_project/brats1517/brats17/test.py  /home/guotwang/tf_project/brats1517/brats17/config17/test_all_class.txt
